...
/**
 * REST controller for managing {@link com.lobbyforplayers.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public List<Order> getAllOrders(@RequestParam(required = false) String filter) {
        if ("item-is-null".equals(filter)) {
            log.debug("REST request to get all Orders where item is null");
            return orderService.findAllWhereItemIsNull();
        }
